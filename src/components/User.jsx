    ...
    if (bookingToDelete) {
      ...
      if (response.ok) {
        const updatedBookings = bookings.filter(
          (booking) => booking._id !== bookingToDelete
        );
        await fetchUserData();
        setBookings(updatedBookings);
      } else {
        setSentence(
          "I'm sorry, you are unable to delete bookings within 24 hours of the scheduled time. Please contact us directly to make any necessary changes. Thank you for your understanding."
        );
        setShowModal(true);
      }
    }
        ...
        <Card.Body>
                    ...
                    {editPhoneNumberMode ? (
                      <span>
                        ...
                        <Button
                          variant="primary"
                          size="sm"
                          onClick={handleUpdatePhoneNumberClick}
                        >
                          {" "}
                          Save{" "}
                        </Button>
                        <Button
                          variant="secondary"
                          size="sm"
                          onClick={() => setEditPhoneNumberMode(false)}
                        >
                          {" "}
                          Cancel{" "}
                        </Button>
          ...
          <div className="bookings">
            ...
            <Modal
              ...
              onHide={handleCancelDeleteBooking}
            >
              ...
              <Modal.Footer>
                <Button variant="secondary" onClick={handleCancelDeleteBooking}>
                  No
                </Button>
                <Button variant="danger" onClick={handleConfirmDeleteBooking}>
                  Yes
                </Button>
              </Modal.Footer>
            </Modal>
            ...
            <div className="card coupon-card">
              <div className="display-coupons">
                ...
                <p>
                  ...
                  next visit!
                  <br /> To redeem this offer,simply show the coupon to our
                  receptionist during your next appointment
                  <br /> or use it with the next online booking.
                  <br /> The coupon can only be used once.
                </p>

                <h4>
                  You have spent: $
                  <span id="amount-spent">{userInfo.amountSpent}</span>
                </h4>
                <h6>
                  Spend ${500 - userInfo.amountSpent} more to recieve the next
                  coupon.
                </h6>
                <h4 className="coupon">
                  You have:{" "}
