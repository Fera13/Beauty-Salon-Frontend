...
export function ViewAdminsAccordion() {
  ...
  useEffect(() => {
    (async () => {
      let admins = await (
        await fetch(`https://beauty-salon-back.onrender.com/admin/getAdmins`)
      ).json();
      setAdminList(admins);
    })();
  }, []);
  ...
  const handleSave = (index, admin) => {
    ...
    (async () => {
      ...
      let response = await fetch(
        `https://beauty-salon-back.onrender.com/admin/updateAdmin`,
        {
          method: "PUT",
  ...
  const handleDelete = (id) => {
    (async () => {
      const packet = { id };
      let response = await fetch(
        `https://beauty-salon-back.onrender.com/admin/removeAdmin`,
        {
          method: "DELETE",
          body: JSON.stringify(packet),
          headers: {
